...
class Date
{
    public:
        ...
        friend bool operator==(const Date& aLHS, const Date& aRHS);
 ...
 *   identical.
 *
 * @param[in] aLHS First input Date instance.
 * @param[in] aRHS Second input Date instance.
...
/**
 * @brief Less than operator for Date class.
 * @ingroup group_time
 *
 * @param[in] aLHS First input Date instance.
 * @param[in] aRHS Second input Date instance.
...
/**
 * @brief Inequality operator for Date.
 * @ingroup group_time
 *
 * @param[in] aLHS First input Date instance.
 * @param[in] aRHS Second input Date instance.
 ...
 */
inline bool operator!=(const Date& aLHS,
                const Date& aRHS)
{
...
/**
 * @brief Less than or equal to operator for Date.
 * @ingroup group_time
 *
 * @param[in] aLHS First input Date instance.
 * @param[in] aRHS Second input Date instance.
...
/**
 * @brief Greater than or equal to operator for Date.
 * @ingroup group_time
 *
 * @param[in] aLHS First input Date instance.
 * @param[in] aRHS Second input Date instance.
...
/**
 * @brief Ostream operator for Date class.
 * @ingroup group_time
 *
 * @param[in,out] os Output stream to modify
 * @param aDate Data object to serialize to stream
